  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative overflow-hidden rounded-2xl border border-glass-border"
          style={{
            ...
            boxShadow: '0 0 0 1px var(--color-glass-border), 0 20px 60px rgba(0, 0, 0, 0.5), 0 0 40px var(--color-primary-glow)',
          }}
        >
          {/* Top decorative bar */}
          <div className="absolute top-0 left-0 right-0 h-1 announcement-glow-bar"
            style={{
      ...
      <style>{`
        ...
        .announcement-glow-bar {
          animation: announcementGlow 3s ease-in-out infinite;
        }
        .announcement-card {
          animation: announcementSlideUp 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
        }
      `}</style>
    </div>
  );
